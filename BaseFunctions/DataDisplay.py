def si_recursive_dict_plotter(dictionary: dict, string= "", itemnumbering: bool = None, level: int = 0, switch=True, on=True):
    """ Function name: si_recursive_dict_plotter =======================================================================
    ...
    if on and switch:
        for key, value in sorted(dictionary.items()):
            if isinstance(value, dict):
                ...
                string = si_recursive_dict_plotter(value, string, itemnumbering, level + 1)
            else:
                line = {
...
def si_recursive_list_plotter(list_in: list, string= "", itemnumbering: bool = None, level: int = 0):
    """ Function name: si_recursive_list_plotter =================================================================
    Template: rdp as in (R)ecursive (D)ictionary (P)lotter
    This is a function to show a dictionary of any deepness in a tree structure.
    Keep it intact, only develop in general ways.
    ...
    for item in list_in:
        if isinstance(item, list):
            ...
            # print(line[itemnumbering])
            string += line[itemnumbering]
            string = si_recursive_list_plotter(item, string, itemnumbering, level + 1)
        else:
            line = {
                False:  level * "| " + "%s\n" % item,
                None:   level * "| " + "%s\n" % item,
...
def si_recursive_data_plotter(data, string= "", itemnumbering: bool = False, level: int = 0, switch=True, on=True):
    """ Function name: si_recursive_data_plotter =================================================================
    ...
    if isinstance(data, list):
        for item in data:
            if isinstance(item, list):
                ...
                string += line[itemnumbering]
                string = si_recursive_data_plotter(item, string, itemnumbering, level + 1)
        ...
        for key, value in sorted(data.items()):
            if isinstance(value, dict):
                ...
                string += line[itemnumbering]
                string = si_recursive_data_plotter(value, string, itemnumbering, level + 1)
...
if __name__  == "__main__":
    ...
    a = si_recursive_data_plotter(data=statedict, string="")
    print(a)
